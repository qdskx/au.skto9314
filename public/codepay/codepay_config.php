...
$codepay_config['go_time'] = 10; //3秒跳转页面 默认为首页
 ...
 *
 */
define('DB_USERTABLE', 'tp_user');  //充值用户所在数据库表名
define('DB_USERMONEY', 'isred');  //充值用户所在表中的金额字段名
