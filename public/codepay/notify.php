...
{ //业务处理例子 返回一些字符串
    ...
    if (!defined('DB_USERTABLE')) defined('DB_USERTABLE', 'user');  //默认的用户数据表
    if (!defined('DB_PREFIX')) defined('DB_PREFIX', 'tp'); //默认的表前缀
...
// header('location:http://au.skxto9314.com');
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="body">
    ...
    <div class="foot">
        <div class="inner">
            <p>如未到账请联系我们</p>
            <p>------------------</p>
            <p style="font-size:28px;color:red"><a href="/" style="color:red">返回首页</a></p>
        </div>
    </div>
