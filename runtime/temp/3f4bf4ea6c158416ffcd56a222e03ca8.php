<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/home/wwwroot/au.skxto9314.com/public/../application/index/view/index/seachres.html";i:1519783681;s:75:"/home/wwwroot/au.skxto9314.com/public/../application/index/view/header.html";i:1519800225;s:75:"/home/wwwroot/au.skxto9314.com/public/../application/index/view/footer.html";i:1519783681;}*/ ?>
<!DOCTYPE html>
<html><head>
...
<div class="ttitle"><h2><i></i>搜索</h2></div>
<form action="/index/index/doseachres" method="post" >
<div style="margin-left:30px;">
	<select name="type" style="width:80px;height:25px;">
		<option>音乐</option>
		<option>MV</option>
		<option>歌单</option>
	</select>
	<input type="text" name="key" style="border:1px solid #aaa;height:23px;margin-bottom: 3px;">
	<input type="submit" style="border:1px solid #aaa;height:25px;margin-bottom:3px;width:80px;">
</div>
</form>

<ul class="news-list">

	<?php if(!empty($se)): if(is_array($se) || $se instanceof \think\Collection): $i = 0; $__LIST__ = $se;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
	<li>
		...
		<span class="misc-wrapper">
			...
			<span class="update-time">2017-01-04</span>
			</span>
		</span>
	</li>
	<?php endforeach; endif; else: echo "" ;endif; endif; if(!empty($se2)): if(is_array($se2) || $se2 instanceof \think\Collection): $i = 0; $__LIST__ = $se2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
	<li>
		<span class="index"></span>
		<span><a href="/index/index/mvplay?vid=<?php echo $val['vid']; ?>"  style="width:300px;display:block;"><?php echo $val['vname']; ?></a></span>
		<span><a style="width:300px;display:block;margin-left:30px;"><?php echo $val['vsinger']; ?></a></span>
		<span class="misc-wrapper">
	...
	<?php endforeach; endif; else: echo "" ;endif; endif; if(!empty($se3)): if(is_array($se3) || $se3 instanceof \think\Collection): $i = 0; $__LIST__ = $se3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
	<li>
		<span class="index"></span>
		<span><a href="/index/index/playlist?pid=<?php echo $val['pid']; ?>"  style="width:300px;display:block;"><?php echo $val['pname']; ?></a></span>
		<span><a  style="width:300px;display:block;margin-left:30px;"></a></span>
		<span class="misc-wrapper">
