<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/home/wwwroot/au.skxto9314.com/public/../application/index/view/index/songlist2.html";i:1519783681;s:75:"/home/wwwroot/au.skxto9314.com/public/../application/index/view/header.html";i:1519800225;s:75:"/home/wwwroot/au.skxto9314.com/public/../application/index/view/footer.html";i:1519783681;}*/ ?>
...
<!-- <link href="/static/index/dist/css/bootstrap.min.css" rel="stylesheet"> -->
...
<div class="bg_box" style="min-height:650px;">
    <div class="main">
    ...
    <div class="malbum_index">
        <?php if(!empty($sel)): if(is_array($sel) || $sel instanceof \think\Collection): $i = 0; $__LIST__ = $sel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
        <dl class="new_music">
            <a target="" href="/index/index/songplay?sid=<?php echo $val['sid']; ?>">
                <dt>
                    <img src="<?php echo $val['pic']; ?>" width="159" height="159" title="<?php echo $val['sname']; ?>--<?php echo $val['singer']; ?>">
                    <span class="malbum"></span>
                </dt>
            </a>
            <dd class="new_music_title"><?php echo $val['sname']; ?>--<?php echo $val['singer']; ?></dd>
            <?php if($val['ispay'] == 1): ?>
            <dd class="new_music_name" style="color:#E85252;">会员专属</dd>
            <?php else: ?>
...
<!--         <div style="background-color:;height:20px;float:left;width:100%;">
            <div style="width:400px;margin:0 auto;background-color:;height:50px;" id="pa">
...
<!--占位的-->
<!-- <div style="width:100%;height:300px;background-color: #f6f6f6">
