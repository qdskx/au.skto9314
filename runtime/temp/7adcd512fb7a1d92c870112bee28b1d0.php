<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/home/wwwroot/au.skxto9314.com/public/../application/admin/view/song/songlist.html";i:1519888424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--             <span class="layui-breadcrumb">
        ...
        <div class="x-body"  style="background: rgba(255,255,255,0.2)">
            ...
            <table class="layui-table" style="background: rgba(255,255,255,0.2)">
                ...
                <tbody id="x-link">
                <?php if(is_array($songinfo) || $songinfo instanceof \think\Collection): $i = 0; $__LIST__ = $songinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td>
                            <input type="checkbox" value="<?php echo $value['sid']; ?>" name="">
                        </td>
                        <td>
                            <?php echo $value['sid']; ?>
                        </td>
                        ...
                        <td >
                            <?php echo $value['singer']; ?>
                        </td>
                        <td>
                            <?php echo $value['stname']; ?>
                        </td>
                        <td>
                        ...
                        <td >
                            <a href='/admin/comment/songcomlist?sid=<?php echo $value['sid']; ?>' class="layui-btn layui-btn-normal layui-btn-mini">
                                查看评论
                            </a>
                        </td>
                        <td class="td-manage">
                            <a title="编辑" href="/admin/song/editsong?sid=<?php echo $value['sid']; ?>"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="javascript:;" onclick="feedback_del(this,<?php echo $value['sid']; ?>)" 
